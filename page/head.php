...
<div id="mySidenav" class="sidenav">
    ...
    <a onclick="closeNav()" href="../TopDeals">Top Deals</a>
    <a onclick="closeNav()" href="../Women_Dress">Wome's Dress</a>
    <a onclick="closeNav()" href="../Men_Clothes">Men's Clothes</a>
    ...
    <nav class="navbar navbar-dark navbar-expand-md" id="app-navbar">
        ...
        <a href="../../" class="navbar-brand">Amazon Retailer</a>
        </div>
    </nav>
